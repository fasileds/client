...
export default function RentedBooks() {
  ...
  const handleOnClick = async (bookId) => {
    try {
      await axios.delete(`http://localhost:3001/api/rent/delete/${bookId}`, {
        data: { userId: userId },
      });
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-full max-w-5xl">
          {books.length > 0 ? (
            ...
            <div className="flex flex-col items-center bg-white p-10 rounded-lg shadow-lg">
              ...
              <a
                href="/user/books"
                className="mt-6 mb-10 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
              >
                Explore Books
              </a>
            </div>
